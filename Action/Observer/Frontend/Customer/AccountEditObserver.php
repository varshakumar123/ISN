...
class AccountEditObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    $db->addData(['cust_name'=>$customerDataName,'cust_action'=>'Editing Account','c_time'=>$date]);
    $db->save();
