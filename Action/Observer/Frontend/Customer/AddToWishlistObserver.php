...
class AddToWishlistObserver implements \Magento\Framework\Event\ObserverInterface
{
    ...
    $db->addData(['cust_name'=>$customerDataName,'cust_action'=>'Add To Wishlist','c_time'=>$date]);
    $db->save();
